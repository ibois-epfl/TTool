...
void Camera::preprocess() {
	...
	auto K = cv::Matx33f(5.6179718862595769e+02, 0., 6.4349424059711373e+02, 0.,
    ...
    auto distCoeffs = cv::Matx<float, 1, 5>(-2.4776321654659408e-01, 7.4589742789025762e-02,
...
//     cv::Mat fgMask = cv::imread("./msasks/drill/mask.jpg", cv::IMREAD_GRAYSCALE);
