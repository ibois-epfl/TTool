...
if __name__ == "__main__":
    network = TransferEfficientNet(num_classes=14)
    module = LitClassifier(network)
    module.load_from_checkpoint("ai/checkpoints/epoch=45-step=28934.ckpt", map_location=torch.device('cpu'), network=network)
